...
public:
    ...
    void setupUi(QMainWindow *inputwindow)
    {
        ...
        label->setGeometry(QRect(1070, 40, 151, 16));
        ...
        xmax->setGeometry(QRect(1200, 90, 62, 22));
        ...
        xmax_2->setGeometry(QRect(1200, 160, 62, 22));
        ...
        formLayoutWidget->setGeometry(QRect(60, 120, 160, 80));
        formLayout = new QFormLayout(formLayoutWidget);
        formLayout->setObjectName("formLayout");
        formLayout->setContentsMargins(0, 0, 0, 0);
        labelClasificacion = new QLabel(centralwidget);
        labelClasificacion->setObjectName("labelClasificacion");
        labelClasificacion->setGeometry(QRect(930, 300, 391, 231));
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(920, 610, 151, 61));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(1160, 610, 151, 61));
    ...
    void retranslateUi(QMainWindow *inputwindow)
    {
        ...
        labelClasificacion->setText(QCoreApplication::translate("inputwindow", "TextLabel", nullptr));
        pushButton->setText(QCoreApplication::translate("inputwindow", "Guardar y Salir", nullptr));
        pushButton_2->setText(QCoreApplication::translate("inputwindow", "Salir", nullptr));
    } // retranslateUi
